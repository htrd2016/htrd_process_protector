...
#salt -G "os:CentOS" cmd.run_all '/root/minion_protector/htrdMinionProtector-el7 /tmp/htrd_minion_alived "systemctl salt-minion stop" "systemctl start salt-minion" 300'
