...
salt -G "os:CentOS7" cp.get_file salt://minion_protector/htrdMinionProtector-el7 /root/minion_protector/htrdMinionProtector-el7 makedirs=True
salt -G "os:CentOS7" cmd.run_all "chmod +x /root/minion_protector/htrdMinionProtector-el7"
